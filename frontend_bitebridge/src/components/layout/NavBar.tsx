...
import { 
    Store, QrCode, ShoppingBag, UserCircle, Menu, X, LogOut, User, ChevronDown, LayoutDashboard
} from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <Link to={isVendorOrStaff ? "/live-orders" : "/"} className="flex-shrink-0 flex items-center gap-2">
                    ...
                    <div className="hidden lg:flex items-center space-x-4 xl:space-x-6">
                        ...
                        {isVendorOrStaff && (
                            <>
                                ...
                                <div className={`px-3 py-1 rounded text-xs font-bold uppercase tracking-wide border ${
                                    role === 'vendorOwner' ? 'bg-orange-100 text-orange-800 border-orange-200' : 'bg-blue-100 text-blue-800 border-blue-200'
                                }`}>
                    ...
                    <div className="px-4 pt-4 space-y-3">
                        ...
                        {role === 'customer' && (
                            <>
                                ...
                                <MobileNavLink to="/checkout" onClick={toggleMenu} icon={<ShoppingBag size={18} />}>
                        ...
                        {isVendorOrStaff && (
                            <>
                                <UserProfileMobile user={authUser} role={role === 'vendorOwner' ? 'Owner' : 'Staff'} />
                                {/* Sirf Dashboard link bacha hai */}
                                <MobileNavLink to="/live-orders" onClick={toggleMenu} icon={<LayoutDashboard size={18} />}>Dashboard</MobileNavLink>
                                <LogoutMobile onClick={handleLogout} />
                            </>
                        )}
                    </div>
